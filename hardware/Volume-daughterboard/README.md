# USBSID-Volume-daughterboard PCB design files
This directory contains the open source KiCad design files for v1.0 of the USBSID-Volume-daughterboard pcb.
