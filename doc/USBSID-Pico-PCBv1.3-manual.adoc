...
An optional Volume daughterboard is available for independent left/right channel volume control. It is compatible with v1.3 boards with a small modification to provide voltage - see the `USBSID-Volume-daughterboard` manual for details.
